...
// In the program above, a channel ch is created and we send 5 to the channel in line no. 10 ch <- 5. In this program no other Goroutine is receiving data from the channel ch. Hence this program will panic with the following runtime error.
